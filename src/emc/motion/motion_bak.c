...
int rtapi_app_main(void)
{
    ...
    Openfile_dx = file_open("/mnt/ramdisk/desp_x_1.txt", O_RDWR | O_CREAT, 0666);
    Openfile_dy = file_open("/mnt/ramdisk/desp_y_1.txt", O_RDWR | O_CREAT, 0666);
    ...
    Openfile_ax = file_open("/mnt/ramdisk/actup_x_1.txt", O_RDWR | O_CREAT, 0666);
    Openfile_ay = file_open("/mnt/ramdisk/actup_y_1.txt", O_RDWR | O_CREAT, 0666);    
